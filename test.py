...
def main():
    ...
    # parser.add_argument('--config', type=str, default='./config/SimREC_RefCOCO_scratch.yaml')
    # parser.add_argument('--eval-weights', type=str, default='logs/det_base_refcoco_baseline_10%_clip_90%_prompt/5591/ckpt/det_best.pth')
