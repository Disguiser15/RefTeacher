...
class head(nn.Module):
    ...
    def forward(self, xin,yin, x_label=None,y_label=None,semi=False,weight=None):
        """
        In this
        Args:
        ...
        if semi == False:
            ...
            if output.size(0) != self.bs_label:
                ...
                loss_obj_unsup = nn.BCELoss(weight=weight.view(weight.size(0),1,1,1).expand_as(target[self.bs_label:,..., 4]))(output[self.bs_label:,..., 4], target[self.bs_label:,..., 4])
            else:
