...
from models.realgin_semi_confidence_modified.head import head
    ...
    def frozen(self,module):
        if getattr(module,'module',False):
            ...
            for param in module.parameters():
                param.requires_grad = False
    def forward(self, x,y, det_label=None,seg_label=None,semi=False,confidence_map=None):
        ...
        if self.training:
            if semi==True:
                loss,loss_det,loss_seg,loss_semi,loss_det_semi,loss_seg_semi=self.head(x,None,det_label,seg_label,semi=True,confidence_map=confidence_map) # x: (B,1024,8,8)
            ...
            return box, mask, confidence_map
