...
class REChead(nn.Module):
    ...
    def forward(self, xin, yin,labels=None,y_label=None,mixup_targets=None, imgs=None,semi=False):
        # print(labels)
        outputs = []
        origin_preds = []
        x_shifts = []
    ...
    def get_losses(
        ...
        if semi == False:
            ...
            loss_sup = reg_weight * loss_iou_sup + loss_obj_sup  + loss_l1
            loss_unsup = loss_obj_unsup  + loss_l1
            return (
